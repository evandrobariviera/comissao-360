...
<div class="secao">
  <h3>Ritmo da filial</h3>
  <p class="secao-sub">Quanto a filial precisa vender por dia útil (sem domingo) pra bater a meta do mês — e como está indo até agora.</p>
...
<div class="secao">
  ...
  <p class="secao-sub">Itens coletivos do pilar Equipe — valem pra todo mundo da filial igual.</p>
...
<div class="secao">
  <h3>Como a filial está indo</h3>
  <p class="secao-sub">Panorama da loja inteira — não só a sua parte.</p>
  <div class="card">
    <?= Viz::meterRow('Venda bruta da filial', $realizadoFilial, $metaVendaFilial) ?>
  </div>
